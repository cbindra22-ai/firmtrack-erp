...
class CustomerAdvanceReportScreen extends StatefulWidget {
  ...
  @override
  State<CustomerAdvanceReportScreen> createState() => _CustomerAdvanceReportScreenState();
}

class _CustomerAdvanceReportScreenState extends State<CustomerAdvanceReportScreen> {
  ...
  Future<void> _loadReport() async {
    ...
    for (final c in customers) {
      ...
      final advance = totalPaid - totalInvoiced;
              ...
              children: [
                Container(
                  ...
                  child: Row(
                    ...
                    children: [
                      const Text('Total Advance Held', style: TextStyle(fontSize: 16, fontWeight: FontWeight.bold)),
                      Text('₹${_fmt2(_totalAdvance)}', style: const TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: Colors.purple)),
                    ],
                  ),
                ),
                Expanded(
                  child: _rows.isEmpty
                      ? const Center(child: Text('No advance amounts found.'))
                      : ListView.builder(
