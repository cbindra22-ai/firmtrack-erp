...
class CustomerOutstandingPdfService {
  static Future<void> generateAndShare({
    ...
    try {
          ...
          return pw.Column(
            ...
            children: [
              pw.Container(
                ...
                child: pw.Column(
                  ...
                  children: [
                    ...
                    pw.Text("Customer Outstanding Report", style: const pw.TextStyle(color: PdfColors.white, fontSize: 11)),
              ...
              pw.Row(
                ...
                children: [
                  pw.Text("Total Outstanding", style: pw.TextStyle(fontSize: 12, fontWeight: pw.FontWeight.bold)),
                  pw.Text("Rs. ${totalOutstanding.toStringAsFixed(2)}", style: pw.TextStyle(fontSize: 13, fontWeight: pw.FontWeight.bold, color: PdfColors.red700)),
                ],
              ),
              pw.SizedBox(height: 12),
              pw.Divider(),
              ...
              pw.Table(
                ...
                children: [
                  pw.TableRow(
                    decoration: const pw.BoxDecoration(color: PdfColors.red700),
                    children: ["Customer", "Phone", "Outstanding"].map((h) => pw.Padding(
                  ...
                  ...rows.map((r) => pw.TableRow(children: [
                    ...
                    pw.Padding(padding: const pw.EdgeInsets.all(6), child: pw.Text("Rs. ${(r["outstanding"] as double).toStringAsFixed(2)}", style: const pw.TextStyle(fontSize: 9, color: PdfColors.red700))),
                  ])),
                ],
              ),
            ],
      ...
      final filePath = "${dir.path}/customer_outstanding_report.pdf";
      final file = File(filePath);
      await file.writeAsBytes(await pdf.save());
      await Share.shareXFiles([XFile(filePath, mimeType: "application/pdf")], subject: "Customer Outstanding Report");
    } catch (e) {
      if (context.mounted) {
